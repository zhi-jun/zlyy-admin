...
namespace ZLYY.Utils.Extensions
{
    ...
    public static class StringExtension
    {
        ...
        /// <summary>
        /// Convert the string to md5 string
        /// </summary>
        ...
        /// <summary>
        /// Converts a normal string to base64 string in specified encoding 
        /// </summary>
        ...
        /// <summary>
        /// Converts a base64 string to a normal string in specified encoding 
        /// </summary>
        /// <param name="str"></param>
        /// <param name="encoding"></param>
        /// <returns></returns>
